function [SE_MMSE, SE_P_MMSE, SE_P_RZF,  ...
    ...
    = functionComputeInterUserGains(Hhat,H,D,B,C,tau_c,tau_p,nbrOfRealizations,N,K,L,p,R,pilotIndex,rho_dist,gainOverNoisedB,rho_tot)
